...
Camera data for blocks 0-36 is hardcoded.
...
# Camera data for blocks 0-36 (from standard ship sprite layout)
# Each entry contains: row, yaw, pitch, and optionally type, camera_up, camera_right
...
def main() -> int:
    ...
    for img in sorted(input_dir.glob('SHIP_block*.png')):
