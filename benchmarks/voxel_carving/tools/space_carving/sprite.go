...
// CameraUpVec returns the camera up vector as common.Vec3.
func (s *Sprite) CameraUpVec() common.Vec3 {
	return common.Vec3{s.CameraUp[0], s.CameraUp[1], s.CameraUp[2]}
}

// CameraRightVec returns the camera right vector as common.Vec3.
func (s *Sprite) CameraRightVec() common.Vec3 {
	return common.Vec3{s.CameraRight[0], s.CameraRight[1], s.CameraRight[2]}
}
